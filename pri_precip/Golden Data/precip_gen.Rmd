...
library(ggplot2)
p1<-ggplot(precipOut) + geom_point(aes(x = time, y = finalPrecip, colour =  gapQF > 0)) +
  scale_colour_manual(name = 'Null', values = setNames(c('red','blue'),c(T, F))) +
...
The plot below shows the status of the priorDepthQF troughout the data set.
```{r,echo=FALSE,warning=FALSE}

##priorDepthQF Plots

library(ggplot2)
p2<-ggplot(precipOut) + geom_point(aes(x = time, y = finalPrecip, colour =  priorDepthQF > 0)) +
  scale_colour_manual(name = 'Prior Depths Missing', values = setNames(c('red','blue'),c(T, F))) +
  xlab('Time') + ylab('Precipitation (mm)')
...
The plot below shows the status of the wireNoiseQF troughout the data set.
```{r,echo=FALSE,warning=FALSE}
##Wire Noise Plot
p3<-ggplot(precipOut) + geom_point(aes(x = time, y = finalPrecip, colour =  wireNoiseQF > 0)) +
  scale_colour_manual(name = 'Wire Noise', values = setNames(c('red','blue'),c(T, F))) +
  xlab('Time') + ylab('Precipitation (mm)')
...
```{r,echo=FALSE,warning=FALSE}
##extreme delta
p4<-ggplot(precipOut) + geom_point(aes(x = time, y = finalPrecip, colour =  exDeltaQF > 0)) +
...
p5<-ggplot(precipOut) + geom_point(aes(x = time, y = finalPrecip, colour =  overflowQF > 0)) +
  scale_colour_manual(name = 'Overflowing Gauge', values = setNames(c('red','blue'),c(T, F))) +
